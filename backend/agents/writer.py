...
font_path = os.path.join(BASE_DIR, "..", "fonts", "ttf", "dejavu-sans-latin-400-normal.ttf")



# Markdown
# SYSTEM_PROMPT = """You are a technical writer. Given research notes and sources on a topic, 
...
Citation rules:
- You MUST add inline citations [1], [2] etc. — this is MANDATORY, not optional
- EVERY factual sentence MUST end with a citation — no exceptions
- Every claim or fact must have a citation
